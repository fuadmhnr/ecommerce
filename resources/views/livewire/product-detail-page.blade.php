        ...
        <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
            <div class="flex flex-wrap -mx-4">
                <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage', $product->images[0]) }}' }">
                    <!-- Changed z-index and added proper spacing -->
                    <div class="sticky top-20 z-30 overflow-hidden bg-white dark:bg-gray-800">
                        <!-- Added proper aspect ratio container -->
                        <div class="relative mb-6 lg:mb-10">
                            <div class="aspect-w-16 aspect-h-12">
                                <img x-bind:src="mainImage" alt="{{ $product->name }}" class="object-cover w-full">
                            </div>
                        </div>
                                ...
                                <div class="w-1/2 p-2 sm:w-1/4" 
                                    ...
                                    <div class="aspect-w-1 aspect-h-1">
                                        <img src="{{ url('storage', $image) }}" 
                                            alt="{{ $product->name }}"
                                            class="object-cover w-full cursor-pointer transition-all duration-300 hover:border-2 hover:border-blue-500">
                                    </div>
                                </div>
                            @endforeach
                        </div>
