        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <span
                            class="bg-yellow-500 py-1 px-3 rounded text-white shadow">{{ ucfirst($order->status) }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-800">
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <span
                            class="bg-green-500 py-1 px-3 rounded text-white shadow">{{ ucfirst($order->payment_status) }}</span>
                    </div>
                </div>
            </div>
        </div>
